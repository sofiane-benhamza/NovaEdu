    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light shadow sticky-top p-0">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <a href="../../forum/" class="nav-item nav-link active">forum</a>
                <div id="fix-phone-deconnect" class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" id="logoutDropdown" role="button" data-bs-toggle="dropdown"
                        aria-expanded="false">
                    </a>
                ...
                <div class="nav-item dropdown">
                    <a class="btn btn-primary py-4 px-lg-5 d-none d-lg-block dropdown-toggle" id="logoutDropdownButton"
